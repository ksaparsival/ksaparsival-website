...
<a href="https://www.facebook.com/ksaparsival/" target="_blank"><div id="facebook_holder_mainpage">&nbsp;</div></a>
<div id="main">
	<div id="hoofdmenu">
    	<a href="info.php?id=over%20ons"><div id="hoofdmenu_info"></div></a>
        <a href="planning.php"><div id="hoofdmenu_planning">&nbsp;</div></a>
        <a href="verhuur.php?id=tenten"><div id="hoofdmenu_verhuur">&nbsp;</div></a>
        <a href="https://www.facebook.com/pg/ksaparsival/photos/?ref=page_internal" target="_blank"><div id="hoofdmenu_fotos">&nbsp;</div></a>
    </div>
    <?php
    ...
    <div id="hoofdmenu_content">
	    ...
	    <strong>24 april</strong> - Buitenspeeldag<br />
          ...
          <p>
            <?php
            for($j=0; $j<count($kalender->planning); $j++){
