...
if ($_GET['id'] == 'weekbrief') {
    ...
    <form enctype="multipart/form-data" action="admin.php?id=maandbrief" method="post">
        <a href="admin.php">Terug naar hoofdmenu</a><br/><br/>
        <b>JE BESTAND KAN MAXIMUM 2MB GROOT ZIJN! LET ER DUS OP HOEVEEL FOTO'S JE GEBRUIKT EN VAN WELKE KWALITEIT ZE
            ZIJN!</b><br/><br/>
        <table>
            <tr>
                <td>Ban:</td>
    ...
    <form action="admin.php?id=kluslijst" method="post">
        ...
        <table>
            <tr>
                <td>Naam:</td>
                <td><input type="text" name="klus_naam" size="60"/></td>
            </tr>
            <tr>
                <td>Omschrijving:</td>
                <td><textarea name="klus_omschrijving" rows="4" cols="60"></textarea></td>
            </tr>
            <tr>
                <td><input type="submit" name="submit" value="Klusje toevoegen"/></td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td><input type="submit" name="submit" value="Klusje verwijderen"/></td>
            </tr>
        </table>
